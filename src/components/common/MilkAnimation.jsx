...
import styles from "../../styles/common/MilkAnimation.module.css";
...
function MilkAnimation() {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      blinkTl.to(["#eye-left-open", "#eye-right-open"], {
        scaleY: 0,
        duration: 0.1,
      ...
      const mouthTl = gsap.timeline({ delay: 2 });
      mouthTl.to("#mouth", {
        opacity: 0,
        duration: 2.5,
        ease: "power1.inOut",
  ...
  return (
    <div className={styles["milk-svg-wrapper"]} ref={svgRef}>
