        ...
        <div className="select-dropdown">
          {filteredIngredients.length > 0 ? (
            filteredIngredients.map((ing) => (
              <div
                key={ing.id}
                className={`select-option ${value === ing.id ? "selected" : ""}`}
...
const IngredientForm = ({
  ...
  <div className="form-group">
    ...
    <div className="ingredient-actions">
      <button type="button" onClick={onAddRow} className="add-new-button">
      ...
      {!showCreate ? (
        ...
        <div className="inline-add">
          <input
            ...
            autoFocus
          />
          <button type="button" onClick={onCreateNew} className="save-btn">
            <Plus size={16} /> Add
          </button>
          <button
            type="button"
